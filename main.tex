...
\newcommand{\singlesource}{\footnote{Single-source claim --- requires independent verification.}}
...
\input{sections/biomechanics}
\input{sections/intervention_studies}
\input{sections/practitioner_consensus}
\input{sections/discussion}

\input{sections/weekly_integration}
\input{sections/performance_testing}
\input{sections/supplements}
\input{sections/injury_management}
