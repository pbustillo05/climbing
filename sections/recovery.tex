...
\begin{longtable}{>{\raggedright\arraybackslash}p{2.2cm}
                  ...
                  >{\raggedright\arraybackslash}p{1.8cm}}
\caption{Peer-reviewed studies cited in this section. CWT = contrast water therapy; CWI = cold-water immersion; DOMS = delayed-onset muscle soreness; P1NP = procollagen type~I N-terminal propeptide; MPS = myofibrillar protein synthesis. S = surrogate; F = functional.}\label{tab:recovery_studies}\\
\toprule
\textbf{Authors} & \textbf{Design / $n$} & \textbf{Intervention} & \textbf{Primary outcome} & \textbf{Effect size} & \textbf{S/F} & \textbf{Quality} \\
\midrule
\endfirsthead
\toprule
\textbf{Authors} & \textbf{Design / $n$} & \textbf{Intervention} & \textbf{Primary outcome} & \textbf{Effect size} & \textbf{S/F} & \textbf{Quality} \\
...
\endhead
\midrule
\multicolumn{7}{r}{\itshape Continued on next page}\\
\endfoot
\bottomrule
\endlastfoot

Mah et al.\ \cite{MMKD11}
& Prospective cohort; $n=11$ basketball players; no control
& Sleep extension ${\approx}+110$~min/night, 5--7~wk vs.\ habitual
& Sprint time, shooting accuracy, PVT reaction time
& Sprint 16.2$\to$15.5~s ($p<0.001$); shooting $+9\%$; PVT 310.8$\to$274.5~ms ($p=0.004$)
& F (sprint, shooting); S (PVT)
& Moderate: no control \\

Milewski et al.\ \cite{MSB+14}\singlesource
& Cross-sectional; $n=112$ adolescent athletes; 1-season
& Sleep $<$8~h vs.\ $\geq$8~h/night
& Sport injury incidence
& OR 1.70 (95\% CI 1.02--2.84) for injury with $<$8~h
& F (injury incidence)
...
Kiviniemi et al.\ \cite{KHKT07}
& RCT; $n=26$ moderately fit males; 4~wk
& HRV-guided vs.\ fixed-schedule endurance training
& VO\textsubscript{2}peak, max running velocity (Loadmax)
& HRV: $\Delta$VO\textsubscript{2}peak $+3.9$ vs.\ $+1.4$~ml$\cdot$kg$^{-1}\cdot$min$^{-1}$ ($p=0.002$); Loadmax $+0.9$ vs.\ $+0.5$~km$\cdot$h$^{-1}$ ($p=0.048$)
& F
& Moderate: small $n$; endurance only \\

Dupuy et al.\ \cite{DDT+18}
& SR + network MA; 99 studies; $n=1{,}395$
& Massage, CWT, CWI, compression, active recovery vs.\ passive rest
& DOMS, fatigue, inflammation, performance
& Massage DOMS: SMD $-0.72$ (95\% CI $-1.13$ to $-0.31$); fatigue $-0.47$. CWT DOMS: SMD $-0.40$ to $-0.60$
& S (DOMS, fatigue); some F
& High: network MA \\

Roberts et al.\ \cite{RRM+15}
& Parallel RCT; $n=21$ resistance-trained males; 12~wk
& CWI (10°C, 10~min) vs.\ active recovery post-session
& Muscle CSA, satellite cell activity, p70S6K, isokinetic strength
& Type~II CSA: $+17\%$ ACT vs.\ ${\approx}0\%$ CWI; isokinetic $+19\%$ ACT only; p70S6K blunted CWI ($p<0.05$)
& S (CSA, signalling) + F (strength)
& High: mechanistic + functional \\

Pearcey et al.\ \cite{PBSK+15}
& RCT crossover; $n=8$
& Foam rolling 20~min post-exercise vs.\ passive rest
& DOMS (VAS), sprint, jump, strength-endurance at 24--72~h
& Sprint 24~h: $-4.4\%$ vs.\ control; DOMS $d=0.59$--0.84; performance $d=0.48$--0.87
& S (DOMS) + F (sprint)
& Moderate: small $n$; lower extremity \\

Molouki et al.\singlesource
& RCT; $n=44$ healthy males
& 5~min forearm/hand massage vs.\ passive movement
& Grip endurance, grip strength
& Endurance: 38.4$\to$46.5~s ($+21\%$, $p<0.001$); strength change NS ($p=0.077$)
& S/F (grip endurance)
& Moderate: single session \\

Mourot et al.\ (2015)\footnote{\toverify: DOI not found in CrossRef; single-source claim. Requires independent DOI verification before submission.}
& Randomised crossover; $n$ climbers
& Active recovery climbing vs.\ walking between maximal bouts
& Subsequent climbing performance (metres ascended)
& $d=0.6$ ($p<0.01$) favouring active recovery
& F (climbing performance)
& Moderate: climbing-specific; small $n$ \\

Shaw et al.\ \cite{SLBR+17}
& Crossover RCT; $n=8$ healthy males; DB
& 15~g gelatin $+$ 48~mg vit.~C vs.\ placebo, 1~h pre-skipping
& P1NP AUC; engineered-ligament collagen content
& P1NP ${\approx}2{\times}$ placebo ($d{\approx}1.2$ from figure; CI not reported); ligament mechanics improved
& S (P1NP; engineered tissue)
& Moderate: small $n$; surrogate \\

Moore et al.\ \cite{MRF+09}
& Dose-response RCT; $n=6$
& Whey protein 0--40~g post-resistance exercise
& Myofibrillar MPS (isotope tracer)
& MPS plateaus at ${\approx}0.24$~g/kg per meal; 20~g sufficient for ${\approx}80$~kg athlete
& S (isotope tracer MPS)
& High: mechanistic; functional translation confirmed \\
...
\begin{evidencebox}{Sleep Extension and Athletic Performance: Basketball Cohort Evidence · \evidencebacked · ESS 4}
...
\textbf{Sleep $<$8~h/night associates with elevated injury risk.}\singlesource Milewski et al.\ (2014) found adolescent athletes sleeping $<$8~h faced OR~1.70 (95\% CI 1.02--2.84) for sport injury over a season vs.\ $\geq$8~h; confounders partially controlled. Functional outcome (injury incidence). \cite{MSB+14}
...
\textbf{Sleep and connective tissue collagen synthesis.} During slow-wave sleep (SWS, NREM~stage~3), pulsatile GH secretion accounts for the majority of daily GH output (Van Cauter et al., 2000, \cite{Van00}). GH stimulates hepatic IGF-1, which upregulates collagen gene expression in tenocytes and fibroblasts. Chronic sleep restriction reduces SWS and therefore GH pulse amplitude. \emph{Direct RCT evidence linking sleep duration or SWS quality to tendon or pulley collagen synthesis, repair timeline, or injury incidence in humans is absent.} Mechanism: SWS $\to$ GH $\to$ IGF-1 $\to$ collagen type~I gene upregulation in fibroblasts/tenocytes; gap: no human tendon biopsy or ultrasound-assessed tendon morphology under controlled sleep manipulation.

Saner et al.\ (2020; \textbf{\toverify: unresolved source DOI in CrossRef lookup}) reported acute sleep deprivation reduced muscle protein synthesis by 18\% in humans (surrogate metabolic outcome, isotope tracer); the extent to which this applies to the slower tendon collagen synthesis pathway is unknown.
\end{bioplausbox}

\begin{folklorebox}{Sleep Hygiene Practices for Athletes · \folkloreverified · ESS 1}
...
\begin{evidencebox}{HRV-Guided Training: Endurance Population RCT Evidence · \evidencebacked · ESS 4}
\textbf{HRV definition and metric.} HRV quantifies beat-to-beat R--R interval variation derived from ECG or photoplethysmography. RMSSD (root mean square of successive differences) is the primary parasympathetic index recommended for daily athlete monitoring; ln(RMSSD) improves normality and is used in HRV4Training (Plews et al., 2013, \cite{WHHB+13}, case series n=4 elite triathletes --- low evidence tier for decision rules, but establishes metric rationale).
...
\begin{evidencebox}{Contrast Water Therapy Reduces DOMS (Dupuy 2018 Network Meta-Analysis) · \evidencebacked · ESS 4}
Dupuy et al.\ (2018) network meta-analysis (99 studies, n=1,395): CWT reduces DOMS vs.\ passive rest; SMD values from contributing trials range approximately $-$0.40 to $-$0.60 (heterogeneous protocols across sources; exact pooled CWT-specific estimate was not consistently reported with CIs across all contributing sources). The effect on \emph{performance} outcomes (strength, power, sprint) was less consistent and smaller. Outcomes are primarily surrogate (DOMS, perceived fatigue). \cite{DDT+18}
\end{evidencebox}

\subsubsection*{Critical Concern: CWI Blunts Strength Adaptation}

\begin{evidencebox}{Cold-Water Immersion Blunts Strength Adaptation (Roberts 2015) · \evidencebacked · ESS 4}
Roberts et al.\ (2015) RCT (n=21, 12-week lower-body strength training programme) demonstrated that CWI (10°C, 10~min) post-session significantly attenuated: type~II fibre CSA (+0\% vs.\ +17\% active recovery; p<0.05); satellite cell proliferation; p70S6K phosphorylation (blunted at 24 and 48~h); isokinetic work (+0\% vs.\ +19\% active recovery). Outcomes: surrogate (CSA, anabolic signalling) and functional (strength). Lower-limb population --- extrapolation to forearm flexors is cautious but mechanistically justified given shared mTOR/satellite cell pathway. \textbf{Routine post-hangboard or post-strength CWI likely blunts intended forearm flexor adaptation.} \cite{RRM+15}
\end{evidencebox}
...
\begin{evidencebox}{Massage and Foam Rolling for Muscle Soreness Recovery (Dupuy 2018; Pearcey 2015) · \evidencebacked · ESS 4}
\textbf{Massage.} Dupuy et al.\ (2018) network meta-analysis: massage showed the largest effect among all modalities for muscle soreness reduction, SMD~$=$~$-$0.72 (95\% CI $-$1.13 to $-$0.31), and for perceived fatigue reduction, SMD~$=$~$-$0.47 (95\% CI $-$0.76 to $-$0.18). Outcomes are predominantly surrogate/perceptual; direct performance recovery effects were smaller and less consistent. \cite{DDT+18}

\textbf{Foam rolling.} Pearcey et al.\ (2015) crossover RCT (n=8): 20~min post-exercise foam rolling reduced DOMS ($d$=0.59--0.84) and attenuated performance decrements at 24~h (sprint $-$4.4\% vs.\ control; $d$=0.48--0.87). Lower extremity; surrogate + functional outcomes. \cite{PBSK+15}
\end{evidencebox}

\subsubsection*{Forearm-Specific Evidence}

\begin{evidencebox}{Forearm Massage Improves Grip Endurance (Molouki 2016) · \evidencebacked · ESS 4}
\textbf{Forearm massage (single-session RCT).}\singlesource Molouki et al.\ (2016) RCT (n=44 healthy males): single 5-min forearm/hand massage increased grip endurance from 38.4 to 46.5~s (+21\%, p<0.001); grip strength change was non-significant (p=0.077). Outcome is a functional surrogate for climbing endurance. Limitations: single session, no repeated-loading context.
\end{evidencebox}
...
\begin{folklorebox}{Climbing-Specific Forearm Recovery Tools · \folkloreverified · ESS 1}
...
\begin{evidencebox}{Active Recovery: Lactate Clearance and Climbing-Specific Performance · \evidencebacked · ESS 5}
Low-intensity aerobic activity accelerates blood lactate clearance vs.\ passive rest: Cochrane (2004, \emph{J Sports Sci} 22(6):501--516)\footnote{\toverify: DOI not found in CrossRef; requires independent DOI verification before submission.} reported \textasciitilde{}30--40\% faster clearance at matched time points, via increased cardiac output sustaining oxidative phosphorylation. Surrogate outcome (lactate); mechanistically translatable to forearm but direct forearm evidence is limited.

Mota et al.\ (2017) crossover (n=14 swimmers):\singlesource 10~min active recovery at \textasciitilde{}69\% trial velocity increased lactate removal to 4.30$\pm$1.74 vs.\ 1.76$\pm$1.70~mmol\textperiodcentered{}L\textsuperscript{-1} (p<0.001) vs.\ passive rest. Surrogate outcome. \cite{MDOS+17}

\textbf{Climbing-specific active recovery (single RCT).}\footnote{\toverify: DOI not found in CrossRef. See table footnote; requires verification.} Mourot et al.\ (2015, \emph{J Sport Sci Med} 14:769--776) found that active recovery using climbing-specific movement between maximal bouts improved subsequent climbing performance vs.\ walking recovery ($d$=0.6, p<0.01). Functional outcome; sport-specific. This is the only climbing-specific controlled study for any recovery modality.
\end{evidencebox}
...
\begin{evidencebox}{Post-Exercise Protein Dose for Muscle MPS (Moore 2009; Morton 2018) · \evidencebacked · ESS 4}
Moore et al.\ (2009) dose-response RCT (n=6): myofibrillar MPS (isotope tracer) plateaus at \textasciitilde{}0.24~g/kg body mass per meal (approximately 20~g for an 80-kg athlete) using whey. Surrogate outcome; functional translation to hypertrophy confirmed in longer-term RCTs. \cite{MRF+09}

Morton et al.\ (2018, \emph{BJSM} 52(6):376--384, \cite{MMM+17}) meta-analysis: total daily protein intake (1.6--2.2~g\textperiodcentered{}kg\textsuperscript{-1}\textperiodcentered{}day\textsuperscript{-1}) is more important than precise post-exercise timing for muscle hypertrophy. Practical target: 0.3--0.4~g/kg per meal, 3--5 meals/day.
...
\textbf{HRV decision rules (session type) --- FOLKLORE, ESS~1:}

The percentage thresholds below (95\%, 90\%) are endurance coaching conventions derived from Ithlete and HRV4Training user data; they have not been validated in RCTs for any isometric strength sport. Treat the specific values as approximate working thresholds, not empirically established cutoffs. The practical logic is sound; the numeric precision is not.

\begin{itemize}[noitemsep]
  \item RMSSD clearly within normal range of 7-day rolling mean (broadly $\geq$90--95\% of mean) + subjectively fresh + no finger soreness: proceed with planned hangboard session.
  \item RMSSD moderately suppressed (broadly 80--90\% of mean) \textbf{or} finger morning stiffness present: reduce hangboard volume 20--50\% or substitute technique day.
  \item RMSSD clearly suppressed ($<$80--90\% of mean) for $\geq$2 consecutive days: postpone high-intensity loading; active recovery or rest.
  \item The meaningful decision boundary is directional trend + symptom agreement, not hitting a precise percentage cut. A single low HRV reading without symptom corroboration warrants caution, not automatic cancellation.
  \item \textbf{Finger symptoms always override HRV}: a normal HRV reading does not clear an irritated pulley for max-load work. Use multi-signal integration (HRV + local VAS + session quality) rather than any single threshold.
\end{itemize}
