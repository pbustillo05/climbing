...
Cross-source metadata review flagged that the volume/page descriptor for Stien et al.\ (2023) is inconsistent across secondary sources (40(3):875--889 \emph{vs.}\ 40(1):179--191). \textbf{[TO\_VERIFY: see Appendix~\ref{app:toverify}, entry 1.]} The version 40(1):179--191 is used here as the closest match to PubMed/PMC records; confirm against \cite{SO23} before citation in other works. Effect-size data (SDM with 95\% CI) are drawn from sources that extracted numeric values with explicit table citation.
...
Stien et al.\ (2023) \textit{Biol Sport} 40(1):179–191. \cite{SO23}
...
López-Rivera \& González-Badillo (2019) \textit{J Hum Kinet} 66:183–194. \cite{O19}
...
Devise et al.\ (2022) \textit{Front Sports Act Living} 4:862782. \cite{DO22}
...
Stien et al.\ (2021) \textit{J Sports Sci Med} 20:438–447. \cite{SPVE21}
...
Wilson et al.\ (2012) \textit{J Strength Cond Res} 26(8):2293–2307. \cite{WMRE12}
...
Supplemental finger-strength training (hangboard or campus board) superimposed on regular climbing training produces significantly greater gains in climbing-specific tests than climbing alone: overall meta-analytic SDM = 0.57 (95\% CI 0.24–0.91), finger strength SDM = 0.41 (0.03–0.80), forearm endurance SDM = 1.23 (0.69–1.77) (Stien et al.\ 2023, \textit{Biol Sport} 40(1):179–191; \cite{SO23}). These studies implicitly impose $\geq$48 h between sessions by scheduling 2–3 sessions/wk but do not experimentally vary session order or inter-session gap. No published RCT has directly randomized the temporal proximity between hangboard training and limit bouldering to measure interference on adaptation outcomes in climbers.
