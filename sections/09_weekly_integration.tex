...
%---------------------------------------------------------------------
\subsection*{Preamble: citation note}

Cross-source metadata review flagged that the volume/page descriptor for Stien et al.\ (2023) is inconsistent across secondary sources (40(3):875--889 \emph{vs.}\ 40(1):179--191). \textbf{[TO\_VERIFY: see Appendix~\ref{app:toverify}, entry 1.]} The version 40(1):179--191 is used here as the closest match to PubMed/PMC records; confirm against DOI~10.5114/biolsport.2023.113295 before citation in other works. Effect-size data (SDM with 95\% CI) are drawn from sources that extracted numeric values with explicit table citation.

%---------------------------------------------------------------------
\subsection{Summary of Cited Peer-Reviewed Studies}
\label{subsec:weekly_table}

\noindent\textbf{EVIDENCE\_BACKED} studies providing direct quantitative data for this section are listed below. Studies not independently confirmed by numeric effect-size verification are excluded from the table and flagged where used in text.

\renewcommand{\arraystretch}{1.3}
\begin{longtable}{>{\raggedright}p{3.4cm} >{\raggedright}p{2.6cm} >{\raggedright}p{3.8cm} >{\raggedright}p{3.1cm} >{\raggedright}p{3.0cm} >{\raggedright\arraybackslash}p{2.2cm}}
\caption{Peer-reviewed studies informing weekly training integration}
\label{tab:weekly_studies}\\
\toprule
\textbf{Study} & \textbf{Design / n} & \textbf{Protocol} & \textbf{Primary outcome} & \textbf{Effect size} & \textbf{Quality} \\
\midrule
\endfirsthead
\multicolumn{6}{l}{\small\itshape Table \ref{tab:weekly_studies} continued\ldots} \\
\toprule
\textbf{Study} & \textbf{Design / n} & \textbf{Protocol} & \textbf{Primary outcome} & \textbf{Effect size} & \textbf{Quality} \\
\midrule
\endhead
...
Stien et al.\ (2023) \textit{Biol Sport} 40(1):179–191. \href{https://doi.org/10.5114/biolsport.2023.113295}{DOI:10.5114/biolsport.2023.113295}
& Systematic review + meta-analysis of RCTs; $n = 11$ studies (5 pooled RCTs for key outcomes)
& Climbing-specific resistance training (hangboard, campus board) 2–3$\times$/wk, 4–10 wk vs.\ climbing-only control
& Finger strength, RFD, forearm endurance (climbing-specific tests)
& Overall SDM = 0.57 (95\% CI 0.24–0.91); finger strength SDM = 0.41 (0.03–0.80); RFD SDM = 0.90 (0.21–1.61, 2 studies); forearm endurance SDM = 1.23 (0.69–1.77)
& GRADE: low-to-moderate. No study blinded participants or assessors; small $n$ per trial; heterogeneous protocols. PEDro median $\approx$5.8 (range 5–7). \\

López-Rivera \& González-Badillo (2019) \textit{J Hum Kinet} 66:183–194. \href{https://doi.org/10.2478/hukin-2018-0057}{DOI:10.2478/hukin-2018-0057}
& RCT, 3 active groups; $n = 26$ advanced sport climbers (mean redpoint 7c+/8a)
& 8 wk, 2 sessions/wk: (A) MaxHangs (18 mm edge + added weight, 10 s hangs $\geq$80\% MFS, 2 phases); (B) IntHangs/repeaters (11 mm, 4–5 $\times$ 10 s/5 s rest); (C) combination. All groups continued regular climbing (6 d/wk, 1.5–2 h/session)
& Grip endurance (time-to-failure dead hang on 11 mm edge, bodyweight)
& IntHangs: $+$45\% (ES = 1.0, $p = 0.002$); MaxHangs: $+$34\% (ES = 0.6, $p = 0.010$); combination: $+$7\% (ES = 0.1, ns). Between-group differences NS at 8 wk ($p > 0.05$).
& GRADE: low. No allocation concealment; no blinding; $n \approx 8$--9 per group; no ITT analysis confirmed. \\

Devise et al.\ (2022) \textit{Front Sports Act Living} 4:862782. \href{https://doi.org/10.3389/fspor.2022.862782}{DOI:10.3389/fspor.2022.862782}
& RCT, 4 groups; $n = 54$ experienced climbers (41 M, 13 F; IRCRA $\approx$18–22)
& 4 wk, 2 sessions/wk, 12 mm hold: F100 (100\% MFS, 6 s $\times$ 6 $\times$ 2 sets); F80 (80\% MFS, 10 s on/6 s off $\times$ 12 $\times$ 3 sets); F60 (60\% MFS, 10 s/6 s $\times$ 24 $\times$ 2 sets); control. $\geq$1 rest day between sessions.
& MFS (N), stamina (force decline under repeated effort), endurance (time to failure at submaximal load)
& F100 MFS $+$14.3 $\pm$ 8.8\% ($p < 0.001$); F80 MFS $+$12.4 $\pm$ 8.4\% ($p < 0.001$); F60 MFS $+$5.9 $\pm$ 8.2\% (ns). F80 stamina 29.5 $\to$ 60.4\% ($p < 0.01$); F60 stamina 32.6 $\to$ 53.5\% ($p < 0.01$). F80 endurance 63.2 $\to$ 79.2\% ($p < 0.001$). F100: stamina/endurance NS.
& GRADE: low. Short 4-wk duration; no blinding; mixed-sex, variable climbing background. \\

Stien et al.\ (2021) \textit{J Sports Sci Med} 20:438–447. \href{https://doi.org/10.52082/jssm.2021.438}{DOI:10.52082/jssm.2021.438}
& RCT; $n = 16$ advanced-to-elite climbers (3 groups: $n = 5$, $n = 6$, $n = 5$ control)
& 5 wk, campus board: 4$\times$/wk vs.\ 2$\times$/wk (volume equated), both vs.\ climbing-only control. All continued normal climbing. $\geq$48 h between sessions specified.
& Bouldering performance, max finger force, campus moves to failure, RFD
& 4$\times$/wk: max force $\uparrow$, RFD $\uparrow$ vs.\ control; 2$\times$/wk: bouldering performance $\uparrow$, campus moves $\uparrow$ vs.\ control; no significant difference between 4$\times$/wk and 2$\times$/wk groups.
& GRADE: very low. $n = 5$–6 per cell; 5-wk duration; no allocation concealment detail. \\

Wilson et al.\ (2012) \textit{J Strength Cond Res} 26(8):2293–2307. \href{https://doi.org/10.1519/JSC.0b013e31823a3e2d}{DOI:10.1519/JSC.0b013e31823a3e2d}
& Meta-analysis; 21 RCTs/CCTs; 422 effect sizes ($n = 422$ aggregated)
& Concurrent strength + endurance vs.\ strength-only; varied modalities (running, cycling), frequencies, durations
& Hypertrophy, maximal strength, power
& Strength ES: strength-only 1.76 vs.\ concurrent 1.44 ($-$18\%); hypertrophy ES: 1.23 vs.\ 0.85 ($-$31\%); power ES: 0.91 vs.\ 0.55 ($-$40\%). Endurance frequency $r = -0.26$ to $-0.35$; duration $r = -0.29$ to $-0.75$. Running $>$ cycling for interference.
& GRADE: moderate (non-climbing population; applicability to isometric forearm loading is inferential). \\
...
\begin{evidencebox}{Supplemental Finger Training Outperforms Climbing Alone (Stien 2023 meta-analysis) · EVIDENCE\_BACKED · ESS 7}
Supplemental finger-strength training (hangboard or campus board) superimposed on regular climbing training produces significantly greater gains in climbing-specific tests than climbing alone: overall meta-analytic SDM = 0.57 (95\% CI 0.24–0.91), finger strength SDM = 0.41 (0.03–0.80), forearm endurance SDM = 1.23 (0.69–1.77) (Stien et al.\ 2023, \textit{Biol Sport} 40(1):179–191; \href{https://doi.org/10.5114/biolsport.2023.113295}{DOI:10.5114/biolsport.2023.113295}). These studies implicitly impose $\geq$48 h between sessions by scheduling 2–3 sessions/wk but do not experimentally vary session order or inter-session gap. No published RCT has directly randomized the temporal proximity between hangboard training and limit bouldering to measure interference on adaptation outcomes in climbers.
...
\begin{folklorebox}{48\,h Minimum Between High-Intensity Finger Sessions · FOLKLORE\_VERIFIED · ESS 1}
...
\textit{Evidence gap: no study has characterised post-Moonboard recovery of MFS, RFD, or tendon stiffness, nor compared its fatigue profile to an equivalent-duration limit-bouldering session.}\footnote{Single-source claim — requires independent verification.}
\end{bioplausbox}
...
Same-session combination is feasible if: (a) max-strength hangboard is performed first, immediately after warm-up; (b) within-session passive gap is $\geq$15–20 min (sufficient for partial PCr resynthesis; not additional forearm loading); (c) total hangboard volume is reduced $\approx$50\% versus a dedicated single-modality session; and (d) total high-intensity time-under-tension remains $<$60 s across both modalities to limit AMPK activation. Combining both modalities in one session does not substitute for two separated sessions, as cumulative volume limits the training signal of each.\footnote{Single-source claim — requires independent verification.}
...
\begin{folklorebox}{Hangboard-First Session Ordering · FOLKLORE\_VERIFIED · ESS 1}
...
\noindent\textit{Primary goal: balanced finger-strength and endurance development. This template most closely replicates the 2$\times$/wk hangboard-plus-normal-climbing design used across Hermans et al.\ (2022)\footnote{Hermans et al.\ (2022) \textit{Front Sports Act Living} 4:888158. \href{https://doi.org/10.3389/fspor.2022.888158}{DOI:10.3389/fspor.2022.888158}. RCT; $n = 35$; 10 wk, 2 sessions/wk (48 min/session), Beastmaker 1000 app-guided protocol; $F_\mathrm{peak}$ $\uparrow$ ($p < 0.05$, large within-group ES) vs.\ control. GRADE: low. TO\_VERIFY: cited by fewer than 3 independent sources; requires verification. See Appendix~\ref{app:toverify}, entry~2.} and consistent with López-Rivera \& González-Badillo (2019).}
...
\begin{folklorebox}{Weekly Hard Finger Exposure Cap: 2--3 Sessions · FOLKLORE\_VERIFIED · ESS 1}
...
Deload indicators for climbing application: (1) max-hang force output declining $>$10\% over 2 consecutive sessions vs.\ 4-week rolling average; (2) subjective RPE for a fixed hangboard protocol increasing $\geq$1.5 points (0–10 scale) without load increase; (3) finger/pulley pain on VAS $\geq$3/10 at rest or $\geq$5/10 during loading — \textbf{mandatory hard stop} regardless of other indicators (may signal A2/A4 pulley irritation requiring medical evaluation); (4) sustained HRV (RMSSD) downward trend over $\geq$5 consecutive training days combined with any two of markers (1), (2), or (5); (5) warm-up grades feeling $\geq$1 full grade harder than baseline for $\geq$7 days.
...
\begin{folklorebox}{Planned Deload Every 3--6 Weeks · FOLKLORE\_VERIFIED · ESS 1}
