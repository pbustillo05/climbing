...
\toprule
\textbf{Study} & \textbf{Design / n} & \textbf{Injury type} & \textbf{Primary outcome} & \textbf{Effect size / key stat} & \textbf{Endpoint} & \textbf{Quality} \\
\midrule
\endhead
\bottomrule
\endfoot

Sjöman, Grønhaug \& Julin (2023). \textit{Wilderness \& Environ Med}, 34(4):397--404. \cite{SGJ23}
...
& $\geq$6\,yr climbers: $\chi^2=4.57$, $p=0.03$ (protective); $<$6\,yr, $\geq$7a climbers: $\chi^2=4.61$, $p=0.03$ (risk)
& \textbf{F} (injury incidence); observational; self-report; no causal inference
& Moderate \\

\addlinespace

Klauser et al.\ (2002). \textit{Radiology}. \cite{KFB+02}
& Diagnostic accuracy; $n=64$ climbers, 75 symptomatic fingers
& Flexor pulley injuries (A2/A3/A4)
& Dynamic US sensitivity/specificity vs.\ MRI reference standard
& Sensitivity 98\%, specificity 100\%; verification bias acknowledged
& \textbf{F} (diagnostic accuracy; returns to climbing not measured)
& Moderate \\

\addlinespace

Berrigan et al.\ (2021). \textit{J Ultrasound Med}. \cite{BWC+21}
& Systematic imaging review
& A2 pulley diagnosis
& US vs.\ MRI/CT sensitivity and specificity across included studies
...
Sch\"{o}ffl et al.\ (2003) \cite{SHWS03}.\footnote{\toverify: DOI unresolved via CrossRef; full metadata manually entered.} \textit{Wilderness \& Environ Med}, 14(2):94--100.
...
& 92\% conservative Grade I--III returned to prior level; Grade IV surgical: largely good; no controls
& \textbf{F} (return to sport); case series; no effect size reported; no RCT
& Low--moderate \\

\addlinespace

Schweizer A.\ (2000). \textit{J Hand Surg (Br)}, 25(3):243--246. \cite{Sch00}
& Biomechanical in-vivo; $n=16$ fingers
& A2 pulley loading / taping
& Bowstringing distance and force absorption under circular taping variants
& Proximal A2 tape: bowstringing $\downarrow$2.8\%, force absorbed $\approx$11\%; distal placement: bowstringing $\downarrow$22\%, force absorbed $\approx$12\%
& \textbf{S} (biomechanical proxy; no clinical outcome or re-injury data)
& Moderate for biomechanics \\

\addlinespace

Alfredson H et al.\ (1998). \textit{Am J Sports Med}, 26(3):360--366. \cite{APJL98}
& Prospective cohort + historical controls; $n=15+15$
& Chronic Achilles tendinosis (tendon analogue)
& Return to running at 12\,wk after eccentric heel-drop vs.\ continued activity
& 100\% return to running (eccentric) vs.\ 0\% (control at midpoint); pain and structure normalised; no formal ES reported
& \textbf{F} (return to sport); high for Achilles; transfer to pulleys bioplausible only
& High (Achilles); ESS 3 for pulley transfer \\

\addlinespace

Cook JL \& Purdam CR (2009). \textit{Br J Sports Med}, 43(6):409--416. \cite{CP08}
...
& No effect size; conceptual framework, no RCT
& \textbf{S} (mechanistic model; not a clinical outcome study)
& Moderate; well-cited model \\

\addlinespace

Rio E et al.\ (2015). \textit{Br J Sports Med}, 49(19):1277--1283. \cite{RKP+15}
& RCT crossover; $n=6$/condition (patellar tendinopathy)
& Patellar tendinopathy (analogue)
& Immediate pain (VAS) and MVIC after isometric vs.\ isotonic leg extension
& Pain: 7.0$\pm$2.04 $\to$ 0.17$\pm$0.41 (isometric); MVIC $\uparrow$18.7$\pm$7.8\%; no CI or formal ES reported
& Mixed: VAS pain reduction (\textbf{F-PRO}), MVIC (\textbf{S}); patellar tendon only; transfer to pulleys bioplausible
& Moderate; very small $n$; single session \\

\addlinespace

Shaw G et al.\ (2017). \textit{Am J Clin Nutr}, 105(1):136--143. \cite{SLBR+17}
& RCT crossover; $n=8$
& Connective tissue (ligament model)
& P1NP AUC; engineered ligament mechanics post-supplement
& P1NP $\approx$2$\times$ placebo ($p{<}0.05$); ligament stiffness $\uparrow$; no CI or formal ES reported
& \textbf{S} (biomarker P1NP; in-vitro ligament; no injury or structural human tendon outcome)
& Moderate; very small $n$ \\

\addlinespace

Iruretagoiena et al.\ (2020). \textit{Wilderness \& Environ Med}. \cite{IUDORL+20}
& Systematic review; 7 studies
& A2/A4 pulley diagnosis
& Ultrasound tendon--bone distance cutoff thresholds
& No consensus; complete A2 rupture cutoffs range 1.9--5.1\,mm across studies
& \textbf{F} (diagnostic accuracy); threshold heterogeneity limits clinical utility
...
\textbf{Grading validity (Bioplausible):} The Sch\"{o}ffl system derives from case series, not a validated prospective grading-outcome study. No inter-rater reliability data from RCTs exists. The system is clinically useful for mapping structural severity to management pathway but should not be treated as a validated prognostic instrument. \textbf{[Bioplausible: supported by case series, Sch\"{o}ffl et al.\ 2003 \cite{SHWS03}; no RCT validation.]}
\end{bioplausbox}
...
\textbf{Return-to-climbing timelines (Bioplausible):} Reported in Sch\"{o}ffl et al.\ (2003, \cite{SHWS03}) case series; not validated in controlled trials.
\begin{itemize}[leftmargin=1.5em,noitemsep]
...
\end{itemize}
\textbf{[Bioplausible: mechanistically consistent with tendon healing biology; Folklore for specific week numbers (Sch\"{o}ffl 2003 case series \cite{SHWS03}).]}
\end{bioplausbox}
...
\textbf{Biomechanical basis (Bioplausible):} Schweizer (2000) in-vivo study ($n=16$ fingers) found tape placed directly over the A2 pulley reduced bowstringing by 2.8\% and absorbed $\approx$11\% of bowstringing force; more distal placement (toward distal end of proximal phalanx) reduced bowstringing by 22\% and absorbed $\approx$12\%. Sch\"{o}ffl et al.\ (2007)\footnote{\toverify: DOI not found in CrossRef; single-source claim --- requires independent verification before submission.} controlled biomechanical study ($n=8$ US, $n=12$ strength assessment) found H-tape reduced tendon-bone distance by 16\% and increased crimp MVC by $+$13\% (no CI reported) vs.\ no tape; no effect in open-hand hang. A systematic review by Larsson et al.\ (2022, \cite{LNB22}) reported low-to-moderate certainty for bowstringing reduction (15--22\%) in injured fingers; no significant effect in uninjured fingers. \textbf{[Bioplausible: small controlled biomechanics data; no RCT for clinical outcomes.]}
\end{bioplausbox}
...
\begin{enumerate}[leftmargin=2em]
  ...
  \item \textbf{H-taping clinical effectiveness.} Schweizer (2000) established small biomechanical reductions; Sch\"{o}ffl et al.\ (2007)\footnote{\toverify: DOI not found in CrossRef.} reported acute crimp-strength improvement. Neither confirms reduced re-injury rate or faster healing in a controlled outcome study. Does H-taping reduce bowstringing enough to change clinical outcomes, or does it act primarily via pain modulation and confidence?
