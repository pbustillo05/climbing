...
The flexor tendon sheath of digits II--V contains five annular (A1--A5) and three cruciate (C1--C3) pulleys. The A2 pulley spans the proximal half of the proximal phalanx and is the largest, least deformable annular pulley; it prevents bowstringing of the flexor digitorum profundus (FDP) and flexor digitorum superficialis (FDS) by maintaining the tendons' mechanical line of action. In published case series, the ring (digit IV) and middle (digit III) fingers account for the large majority of pulley injuries in climbers \cite{SHWS03,VQPC08}\footnote{Sch\"{o}ffl et al.\ (2003, \cite{SHWS03}) cohort of 122 pulley injuries confirms ring/middle predominance. Vigouroux et al.\ (2008, \cite{VQPC08}) is a conference abstract; precise digit-frequency percentages require verification from full proceedings before use as a specific numerical claim.}, consistent with their role as the primary force-bearing digits in crimp configurations.
...
%---------------------------------------------------------------------
\subsection{Collateral Ligament Injuries}
\label{subsec:collateral}

PIP and DIP collateral ligament sprains arise from lateral or torsional loading: sidepulls, gastons, underclings, and dynamic slips where a finger contacts the hold obliquely. The PIP joint is most commonly involved. Presentation: focal joint-line tenderness (radial or ulnar side), swelling, and pain with lateral (varus/valgus) stress testing --- without bowstringing and without the focal proximal-phalanx tenderness of a pulley injury. The injury is frequently misidentified as a pulley strain, delaying appropriate management.

\begin{bioplausbox}{Collateral Ligament Sprain: Diagnosis and Management · \bioplausible · ESS 2}
\textbf{Diagnosis (Bioplausible):} Lateral stress testing with the PIP joint at 20--30$^\circ$ flexion is the primary clinical test; pain and/or laxity indicate collateral involvement. Stability under stress determines management grade. US can visualise the ligament and quantify gapping; MRI is preferred for complex or multi-structure injuries. \textbf{[Bioplausible: extrapolated from general hand surgery; no climbing-specific diagnostic validation study.]}

\textbf{Management by stability grade (Bioplausible):}
\begin{itemize}[leftmargin=1.5em,noitemsep]
  \item \textbf{Stable (Grade I--II, no laxity on stress testing):} Buddy-taping to the adjacent finger; early active ROM within pain tolerance; avoid lateral loading (sidepulls, gastons) for 2--4\,wk; return to modified climbing from week 1--2.
  \item \textbf{Lax or complete (Grade II with laxity, Grade III):} 3--4\,wk rigid protective splinting at functional PIP position; formal hand therapy referral; return to full lateral loading at 6--8\,wk guided by valgus/varus stress-test pain.
  \item \textbf{Full-crimp grip} imposes additional lateral load on collateral ligaments; open-hand grip is preferred during recovery across all grades.
\end{itemize}
No climbing-specific controlled series exists for this injury. Management is extrapolated from general finger injury hand surgery principles; specific timelines carry low certainty. \textbf{[Bioplausible: mechanistic and management framework from general hand surgery; no climbing-specific RCT or case series with imaging-confirmed classification.]}
\end{bioplausbox}
...
\begin{enumerate}[leftmargin=2em]
  ...
  \item \textbf{Collateral ligament injury: epidemiology and climbing-specific management.} No prospective climbing study has measured collateral ligament sprain incidence, characterised injury grade distribution, or evaluated protective splinting versus buddy-taping for return timeline or re-sprain rate. The entire management framework is extrapolated from general hand surgery. A registry study analogous to Sch\"{o}ffl (2003) but covering non-pulley finger injuries (collateral ligament, volar plate, joint capsule) would establish the climbing-specific prevalence and natural history of these conditions.
\end{enumerate}
