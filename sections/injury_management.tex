...
Sch\"{o}ffl et al.\ \cite{SHWS03}\footnote{\toverify: DOI unresolved via CrossRef; full metadata manually entered.}
...
& 92\% conservative Gr.~I--III returned to prior level; Grade IV surgical largely good; no controls
